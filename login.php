...
<main>
    ...
    <form action="<?php echo $base_url;?>" method="post" id="loginform" class="login-form">
        ...
        <div>
            ...
            <input <?php echo $phoneErr != null ? 'class="error"': 'class=""';?> type="tel" id="phone" name="phone" placeholder="Enter your mobile no." required>
            <span <?php echo $phoneErr != null ? 'class="error"': 'class=""';?>> <?php echo $phoneErr;?></span>
        </div>
        <div>
            <label for="email">Email Address:</label>
            <input <?php echo $emailErr != null ? 'class="error"': 'class=""';?> type="email" name="email" id="email" placeholder="Enter your email id" required>
            <span <?php echo $emailErr != null ? 'class="error"': 'class=""';?>> <?php echo $emailErr;?></span>
        </div>
        <section>
            <button onclick="validation()" type="submit">Continue</button>
        </section>
        <div>
