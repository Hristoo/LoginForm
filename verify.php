...
<?php
   ...
   <html lang="en">
    ...
    <main>
        ...
        <form action="<?php echo $base_url;?>?verify=mail" method="post" id="codeform" class="login-form">
            <section class="top-section">
                <a href="login.php">
                    <img src="img/arrow.png" />
                </a>
                <h5>A 6-digit code has been sent as a text messge to <span><?php echo $email ?></span></h5>
            </section>
            <div>
                <label for="code">Verification code:</label>
                <input <?php echo $err != null ? 'class="error"': 'class=""';?> type="number" id="code" name="code"  placeholder="Enter 6-digit verification code here" required>
                <span class="<?php echo $err != '' ? 'error': '';?>"> <?php echo $err;?></span>
                
            </div>
            <section>
                <button onclick="validationCode()" type="submit">Continue</button>
            </section>
...
if($_GET["verify"] == "phone"){
   ...
   <html lang="en">
    ...
    <main>
        ...
        <form action="<?php echo $base_url;?>?verify=phone" method="post" id="codeform" class="login-form">
            <section class="top-section">
                <a href="login.php">
                    <img src="img/arrow.png">
                </a>
                <h5>A 6-digit code has been sent as a text messge to <span><?php echo $phone ?></span></h5>
        </section>
            <div>
                <label for="code">Verification code:</label>
                <input <?php echo $err != null ? 'class="error"': 'class=""';?> type="number" id="code" name="code" placeholder="Enter 6-digit verification code here" required>
